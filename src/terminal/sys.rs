...
#[cfg(unix)]
pub use self::unix::{supports_keyboard_enhancement, supports_synchronized_output};
#[cfg(windows)]
...
#[cfg(windows)]
pub use self::windows::{supports_keyboard_enhancement, supports_synchronized_output};
